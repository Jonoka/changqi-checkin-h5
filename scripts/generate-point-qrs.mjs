...
function printPage(points, warning, accountName) {
  const sign = `请从“${accountName}”公众号菜单进入活动，点击“扫一扫打卡”，扫描此码并上传现场照片。`
  return `<!doctype html>
